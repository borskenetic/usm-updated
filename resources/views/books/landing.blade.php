        ...
        <section class="opac-links-block" aria-labelledby="opac-links-heading">
            <div class="opac-links-inner">
                ...
                <ul class="opac-links-list">
                    <li>
                        <a class="opac-link-card" href="https://zendy.io" target="_blank" rel="noopener noreferrer">
                            <img src="{{ asset('images/zendy.png') }}" alt="Zendy" class="opac-link-card__img">
                            <span class="opac-link-card__label">Zendy</span>
                        </a>
                    </li>
                    <li>
                        <a class="opac-link-card" href="{{ route('home') }}">
                            <img src="{{ asset('images/d.png') }}" alt="School home" class="opac-link-card__img">
